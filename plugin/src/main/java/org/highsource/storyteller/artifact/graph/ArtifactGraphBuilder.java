...
public interface ArtifactGraphBuilder {
	...
	public DirectedGraph<Artifact, VersionedEdge> buildArtifactGraph(Set<Artifact> artifacts,
			...
			List<ResolutionListener> listeners, Logger logger) throws ArtifactNotFoundException,
